...
const PAGES = {
  ...
  strategy: () => <Placeholder title="Strategy Builder" note="Rule editor UI goes here." />,
  logs: () => <Placeholder title="Logs" note="Full searchable log history goes here." />,
  settings: () => <Placeholder title="Settings" note="Risk params, credentials, symbol config go here." />,
};
