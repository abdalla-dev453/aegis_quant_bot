...
class MT5Credentials:
    ...
    server: str = os.getenv("MT5_SERVER", "YourBroker-Demo")
...
@dataclass(frozen=True)
class NewsAPIConfig:
    api_key: str = os.getenv("NEWS_API_KEY", "REPLACE_WITH_REAL_KEY")
    base_url: str = "https://api.example-economic-calendar.com/v1"

    # How long b4/after ahigh-impact release the bot refuses new trades 
